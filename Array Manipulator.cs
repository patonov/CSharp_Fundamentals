...
namespace Array_Manipulator
{
    class Program
    {
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        Console.WriteLine("[{0}]", string.Join(", ", finalArr));
        ...
        static void PrintArrayWithoutZero(int[] temp)
        {
            ...
            Console.WriteLine("[{0}]", string.Join(", ", newTemp));
        }
        ...
        static void PrintLastEvenOrodd(int[] numbers, int count, string evenOrOdd)
        {
            ...
            else
            {
                if (evenOrOdd == "odd")
                {
                    ...
                    {
                        Console.WriteLine("[{0}]", string.Join(", ", OddArr));
                    }
                    else
                    {
                ...
                else
                {
                    ...
                    {
                        Console.WriteLine("[{0}]", string.Join(", ", evenArr));
                    }
                    else
                    {
                        int[] temp = new int[count];
